 ...
 *   },
 *   links = {
 *     "add-form" = "/admin/config/ebms/state/add",
 *     "edit-form" = "/admin/config/ebms/state/{ebms_article_state_type}/edit",
 *     "delete-form" = "/admin/config/ebms/state/{ebms_article_state_type}/delete",
 *     "collection" = "/admin/config/ebms/state",
 *   },
 * )
 */
